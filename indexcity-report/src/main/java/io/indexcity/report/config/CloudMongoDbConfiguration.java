package io.indexcity.report.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import io.indexcity.report.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("io.indexcity.report.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("io.indexcity.report.config.dbmigrations");
