...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "indexcity@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "indexcity API";

        private String description = "indexcity API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "indexcity";
