...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "injector@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "injector API";

        private String description = "injector API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "injector";
